...
twitch_miner = TwitchChannelPointsMiner(
    username="kodokushi13_",
    password="78$jcv*H$5&@7!@0@880!OfzM8y$3V",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            ...
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION, Events.BET_GENERAL, Events.BET_WIN],                                  # Only these events will be sent to the chat
        ),
        webhook=Webhook(
    ...
    streamer_settings=StreamerSettings(
        ...
        bet=BetSettings(
            strategy=Strategy.MOST_VOTED,            # Choose you strategy!
